...
The total number of permutations of the four player's ahnds is

\[
\binom{52}{13} \cdot \binom{39}{13} \cdot \binom{26}{13} \cdot \binom{13}{3}
\] 
...
\[
\frac{A \cdot B}{\binom{52}{13} \cdot \binom{39}{13} \cdot \binom{26}{13} \cdot \binom{13}{3}} = 0.3656
.\] 
\end{solution}
...
since there is an equal probability for each ace to give to each person,
the probability that they get those aces is $(\frac{1}{4})^{2}$. The 
probability that the other aces go to C and D is $(\frac{2}{4})^2$. Thus, our
answer is 
